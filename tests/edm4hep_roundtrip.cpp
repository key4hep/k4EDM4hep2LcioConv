...
int main() {
  ...
  ASSERT_SAME_OR_ABORT(edm4hep::ParticleIDCollection, "recos_PID_pidAlgo_0")
  ASSERT_SAME_OR_ABORT(edm4hep::ParticleIDCollection, "recos_PID_pidAlgo_1")
  ASSERT_SAME_OR_ABORT(edm4hep::ParticleIDCollection, "recos_PID_pidAlgo_2")
